...
# Cloud of points encoded in input format (7.1.4)
t_design_input = (
...
# Cloud of points encoded in input format (7.1.4) for plotting
...
plots_general(output_layout, speaker_signals, cloud_plots, True, False, "704transcoding5OA_direct")
#######################################################
